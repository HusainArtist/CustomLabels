...
walkway_additional_boundary = 150
...
def main():
    ...
    for a_dataset_file in dataset_file_names:
        ...
        if blockage_instance > 0:
            ...
            blockage_duration = ((blockage_instance * 0.02)/15)
            statement = "Blockage scenario detected in " +a_dataset_file+ " with " +str(blockage_instance)+ " instances with blockage duration " +blockage_duration+ " mins.\n"
